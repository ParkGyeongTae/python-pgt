...
if __name__ == '__main__':
    ...
    before_standard = (datetime.now() - relativedelta(months = 3)).strftime('%Y-%m-%d')
    # end_date = '2023-02-17'
    ...
    df = pd.concat([df_exchange_rate, df_kospi, df_kosdaq], axis = 1, join = 'inner')
    stock_list = ['USD/KRW', 'KOSPI', 'KOSDAQ']
